...
##    j.sleep(10)
    ...
    menu_list.append("2相")
    menu_list.append("3相")
    menu_list.append("ALL")
    menu_list.append("Shunt_ALL")
    menu_list.append("Core_ALL")
    menu_list.append("終了")


    while True:

        getmenu = j.popupmenu2(menu_list)
        getmenu = str(menu_list[getmenu])
    ...
    ##    fig.canvas.manager.full_screen_toggle() # toggle fullscreen mode
        ...
        while True:
            ...
            if getmenu == "1相":
                ...
                ax1.plot(x1,y2,linewidth=2,color="darkgreen",linestyle="-",label="Shunt3")
            elif getmenu == "ALL":
                ax1.plot(x1,y1,linewidth=2,color="red",linestyle="-",label="Core1")##ax1.plot(x1,y1,marker=".",linewidth=3,color="red",linestyle="-",label="Sen1")
                ...
                ax1.plot(x1,y6,linewidth=2,color="darkgreen",linestyle="-",label="Shunt6")
            elif getmenu == "Shunt_ALL":
                ax1.plot(x1,y1,linewidth=2,color="deeppink",linestyle="-",label="Shunt1")
                ax1.plot(x1,y2,linewidth=2,color="skyblue",linestyle="-",label="Shunt2")
                ax1.plot(x1,y3,linewidth=2,color="darkgreen",linestyle="-",label="Shunt3")
            elif getmenu == "Core_ALL":
